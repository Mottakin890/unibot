...
export function WidgetClient({ chatbotId, chatbotName, welcomeMessage }: WidgetClientProps) {
  return (
    <div className="flex flex-col h-svh bg-card">
      ...
      <div className="flex items-center gap-3 px-4 py-3.5 border-b border-border bg-foreground shrink-0">
        <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-background/10">
